...
@interface DrawViewControllerRight(){
...
@implementation DrawViewControllerRight
...
-(void)loadMainImage
{
    ...
    filenamethumb = [filenamethumb mutableCopy];
    [filenamethumb appendString: @"big2"];
    filenamethumb = [filenamethumb mutableCopy];
...
- (void)viewDidLoad
{
        ...
        if((![appDelegate.globalDate isEqualToString:@"new_version"])||(![appDelegate.globalDate isEqualToString:@"men_heads"]))
    {
        ...
        [self.NewImageView setImage:[UIImage imageNamed:@"View_right_created.png"]];
        [self.middleImg setImage:[UIImage imageNamed:@"View_right_created_tr.png"]];
        [self.previewImageView setImage:[UIImage imageNamed:@"View_right_created_tr.png"]];
    ...
    {
        [self.NewImageView setImage:[UIImage imageNamed:@"right_7p_tr.png"]];
        [self.middleImg setImage:[UIImage imageNamed:@"right_7p_tr.png"]];
        [self.previewImageView setImage:[UIImage imageNamed:@"right_7p_tr.png"]];
    }
    ...
    if (((screenHeight==1024)&&[appDelegate.globalDate isEqualToString:@"new_version"])||
        ...
        [self.NewImageView setImage:[UIImage imageNamed:@"ipad_right.png"]];
        [self.middleImg setImage:[UIImage imageNamed:@"ipad_right_tr.png"]];
        [self.previewImageView setImage:[UIImage imageNamed:@"ipad_right_tr.png"]];
    ...
    if ((screenHeight==812)&&[appDelegate.globalDate isEqualToString:@"new_version"])
    {
        ...
        [self.NewImageView setImage:[UIImage imageNamed:@"x_right.png"]];
        [self.middleImg setImage:[UIImage imageNamed:@"x_right_tr.png"]];
        [self.previewImageView setImage:[UIImage imageNamed:@"x_right_tr.png"]];
    }
    ...
    [self.NewImageView setImage:[UIImage imageNamed:@"men-iphone7-right.png"]];
            [self.middleImg setImage:[UIImage imageNamed:@"men-iphone7-right-tr.png"]];
            [self.previewImageView setImage:[UIImage imageNamed:@"men-iphone7-right-tr.png"]];
        }
        ...
        if (((screenHeight==1024)&&[appDelegate.globalDate isEqualToString:@"men_heads"])||
           ...
           ((screenHeight==834)&&[appDelegate.globalDate isEqualToString:@"men_heads"])){
            ...
            [self.NewImageView setImage:[UIImage imageNamed:@"men-ipad-right.png"]];
            [self.middleImg setImage:[UIImage imageNamed:@"men-ipad-right-tr.png"]];
            [self.previewImageView setImage:[UIImage imageNamed:@"men-ipad-right-tr.png"]];
            
        }
        if ((screenHeight==812)&&[appDelegate.globalDate isEqualToString:@"men_heads"])
        {
            
            [self.NewImageView setImage:[UIImage imageNamed:@"men-right-11.png"]];
...
///////////////////////////////////////////////////////////////
  ...
  [self.lineButton setSelected:YES];
    ...
    penbtn.backgroundColor = [UIColor colorWithRed:0.46 green:0.46 blue:0.46 alpha:1.0];
     ...
     // [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(prepareForSegue:sender:s) name:UIApplicationDidEnterBackgroundNotification object:nil];
...
- (void)longPressHandlerPen:(UILongPressGestureRecognizer *)gestureRecognizer {
    ...
    if (gestureRecognizer.state==UIGestureRecognizerStateBegan)
    {
        ...
        self.popoverController2 = [[WEPopoverController alloc] initWithContentViewController:contentViewController];
        self.popoverController2.delegate = self;
        [self.popoverController2 presentPopoverFromRect:CGRectMake(penbtn.frame.origin.x,penbtn.frame.origin.y,0,0 ) inView:self.view permittedArrowDirections:UIPopoverArrowDirectionDown animated:YES];
    }
    else if
...
- (void)longPressHandler:(UILongPressGestureRecognizer *)gestureRecognizer {
    ...
    if (gestureRecognizer.state==UIGestureRecognizerStateBegan)
    {
        ...
        [self.popoverController2 presentPopoverFromRect:CGRectMake(blackbtn.frame.origin.x,blackbtn.frame.origin.y,0,0 ) inView:self.view permittedArrowDirections:UIPopoverArrowDirectionDown animated:YES];
    }
    else
    {
...
- (void)longPressHandlerBlue:(UILongPressGestureRecognizer *)gestureRecognizer {
    ...
    if (gestureRecognizer.state==UIGestureRecognizerStateBegan)
    {
        ...
        [self.popoverController2 presentPopoverFromRect:CGRectMake(bluebtn.frame.origin.x,bluebtn.frame.origin.y,0,0 ) inView:self.view permittedArrowDirections:UIPopoverArrowDirectionDown animated:YES];
    }
...
- (void)longPressHandlerRed:(UILongPressGestureRecognizer *)gestureRecognizer {
    ...
    if (gestureRecognizer.state==UIGestureRecognizerStateBegan)
    {
        ...
        [self.popoverController2 presentPopoverFromRect:CGRectMake(redbtn.frame.origin.x,redbtn.frame.origin.y,0,0 ) inView:self.view permittedArrowDirections:UIPopoverArrowDirectionDown animated:YES];
...
- (void)longPressHandlerLine:(UILongPressGestureRecognizer *)gestureRecognizer {
    ...
    if (gestureRecognizer.state==UIGestureRecognizerStateBegan)
    {
        ...
        [self.popoverController2 presentPopoverFromRect:CGRectMake(lineButton.frame.origin.x,lineButton.frame.origin.y,0,0 ) inView:self.view permittedArrowDirections:UIPopoverArrowDirectionDown animated:YES];
    }
...
- (IBAction)reset:(id)sender {
    ...
    actionSheet2 = [[UIActionSheet alloc] initWithTitle:@"" delegate:self cancelButtonTitle:@"Cancel" destructiveButtonTitle:@"Clear Page" otherButtonTitles:nil, nil];
    actionSheet2.delegate = self;
    
    [actionSheet2 showFromBarButtonItem:sender animated:YES];
...
- (void)saveImage{
   ...
   // [self.NewImageView performSelectorInBackground:@selector(setImage:) withObject:UIGraphicsGetImageFromCurrentImageContext()];
    ...
    filenamebig2 = self.stringForLabel;
...
-(void)setButtonVisible
{
    ...
    [self.popoverBtn1 setEnabled:NO];
...
-(IBAction)buttonTouched:(id)sender
{
        ...
        
    {
        ...
        [self.popoverBtn1 setEnabled:YES];
