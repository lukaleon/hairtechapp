...
- (void)pinchGesture:(UIPinchGestureRecognizer *)gestureRecognizer
{
  ...
  /*
    ...
    if (gestureRecognizer.state == UIGestureRecognizerStateBegan) {
        boundsBeforeScaling = gestureRecognizer.view.bounds;
        transformBeforeScaling = gestureRecognizer.view.transform;
    }
    
    CGPoint center = gestureRecognizer.view.center;
    CGAffineTransform scale2 = CGAffineTransformScale(CGAffineTransformIdentity,
                                                      gestureRecognizer.scale,
                                                      gestureRecognizer.scale);
    CGRect frame = CGRectApplyAffineTransform(boundsBeforeScaling, scale2);
    ...
    gestureRecognizer.view.transform = transformBeforeScaling;*/
}
