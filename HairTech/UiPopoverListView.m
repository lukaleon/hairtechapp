...
- (void)defalutInit
{
    ...
    _titleView.backgroundColor = [UIColor colorWithRed:67.0f/255.0f green:150.0f/255.0f blue:203.0f/255.0f alpha:1.0f];//[UIColor colorWithRed:92./255.
                                   //              green:107./255.
                                     //             blue:131./255.
                                       //          alpha:1.0f];
   // UIColor *mycolor2 = [UIColor colorWithRed:67.0f/255.0f green:150.0f/255.0f blue:203.0f/255.0f alpha:1.0f];
    
    _titleView.font = [UIFont fontWithName:@"HelveticaNeue" size:18];
