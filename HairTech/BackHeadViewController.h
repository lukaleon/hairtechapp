...
@protocol BackHeadViewControllerDelegate<NSObject>
...
@interface BackHeadViewController : UIViewController {
//@interface DrawViewController : UIViewController<WEPopoverControllerDelegate, UIPopoverControllerDelegate,ACEDrawingViewDelegate ,ColorViewControllerDelegate , UIScrollViewDelegate>{
    ...
    NSMutableString *filenamebig5;
    UIImage *tempthumbimage;

    WEPopoverController *popoverController5;
...
@property (weak, nonatomic) id<BackHeadViewControllerDelegate>backheadcontrollerdelegate;
