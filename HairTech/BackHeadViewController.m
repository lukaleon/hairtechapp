...
- (void)longPressHandlerPen:(UILongPressGestureRecognizer *)gestureRecognizer {
    ...
    if (gestureRecognizer.state==UIGestureRecognizerStateBegan)
    {
        ...
        self.popoverController5 = [[WEPopoverController alloc] initWithContentViewController:contentViewController];
        self.popoverController5.delegate = self;
        [self.popoverController5 presentPopoverFromRect:CGRectMake(penbtn.frame.origin.x,penbtn.frame.origin.y,0,0 ) inView:self.view permittedArrowDirections:UIPopoverArrowDirectionDown animated:YES];
    }
    else if
...
- (void)longPressHandler:(UILongPressGestureRecognizer *)gestureRecognizer {
    ...
    if (gestureRecognizer.state==UIGestureRecognizerStateBegan)
    {
        ...
        [self.popoverController5 presentPopoverFromRect:CGRectMake(blackbtn.frame.origin.x,blackbtn.frame.origin.y,0,0 ) inView:self.view permittedArrowDirections:UIPopoverArrowDirectionDown animated:YES];
    }
    else
    {
...
- (void)longPressHandlerBlue:(UILongPressGestureRecognizer *)gestureRecognizer {
    ...
    if (gestureRecognizer.state==UIGestureRecognizerStateBegan)
    {
        ...
        [self.popoverController5 presentPopoverFromRect:CGRectMake(bluebtn.frame.origin.x,bluebtn.frame.origin.y,0,0 ) inView:self.view permittedArrowDirections:UIPopoverArrowDirectionDown animated:YES];
    }
...
- (void)longPressHandlerRed:(UILongPressGestureRecognizer *)gestureRecognizer {
    ...
    if (gestureRecognizer.state==UIGestureRecognizerStateBegan)
    {
        ...
        [self.popoverController5 presentPopoverFromRect:CGRectMake(redbtn.frame.origin.x,redbtn.frame.origin.y,0,0 ) inView:self.view permittedArrowDirections:UIPopoverArrowDirectionDown animated:YES];
...
- (void)longPressHandlerLine:(UILongPressGestureRecognizer *)gestureRecognizer {
    ...
    if (gestureRecognizer.state==UIGestureRecognizerStateBegan)
    {
        ...
        [self.popoverController5 presentPopoverFromRect:CGRectMake(lineButton.frame.origin.x,lineButton.frame.origin.y,0,0 ) inView:self.view permittedArrowDirections:UIPopoverArrowDirectionDown animated:YES];
    }
