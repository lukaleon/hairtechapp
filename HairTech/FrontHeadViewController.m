...
@implementation FrontHeadViewController
...
{
    if(actionSheet4.visible)
        [actionSheet4 dismissWithClickedButtonIndex:-1 animated:YES];
    [self closeAndSave];
...
- (void)viewDidLoad
{
     ...
     if((![appDelegate.globalDate isEqualToString:@"new_version"])||(![appDelegate.globalDate isEqualToString:@"men_heads"]))
       {
        ...
        [self.middleImg setImage:[UIImage imageNamed:@"View_front_created_transp.png"]];
        [self.previewImageView setImage:[UIImage imageNamed:@"View_front_created_transp.png"]];
    ...
    if (((screenHeight==736)&&[appDelegate.globalDate isEqualToString:@"new_version"])||((screenHeight==568)&&[appDelegate.globalDate isEqualToString:@"new_version"])||((screenHeight==667)&&[appDelegate.globalDate isEqualToString:@"new_version"]))
    {
        ...
        [self.NewImageView setImage:[UIImage imageNamed:@"front_7p_tr.png"]];
        [self.middleImg setImage:[UIImage imageNamed:@"front_7p_tr.png"]];
        [self.previewImageView setImage:[UIImage imageNamed:@"front_7p_tr.png"]];
    }
    ...
    if (((screenHeight==1024)&&[appDelegate.globalDate isEqualToString:@"new_version"])||
        ...
        [self.NewImageView setImage:[UIImage imageNamed:@"ipad_front.png"]];
        [self.middleImg setImage:[UIImage imageNamed:@"ipad_front_tr.png"]];
        [self.previewImageView setImage:[UIImage imageNamed:@"ipad_front_tr.png"]];
    ...
    if ((screenHeight==812)&&[appDelegate.globalDate isEqualToString:@"new_version"])
    {
        ...
        [self.NewImageView setImage:[UIImage imageNamed:@"x_front.png"]];
        [self.middleImg setImage:[UIImage imageNamed:@"x_front_tr.png"]];
    ...
    /*----------------------MEN HEADS------------------------------*/
       ...
       [self.NewImageView setImage:[UIImage imageNamed:@"men-iphone7-front.png"]];
               [self.middleImg setImage:[UIImage imageNamed:@"men-iphone7-front-tr.png"]];
               [self.previewImageView setImage:[UIImage imageNamed:@"men-iphone7-front-tr.png"]];
           }
           ...
           if (((screenHeight==1024)&&[appDelegate.globalDate isEqualToString:@"men_heads"])||
              ...
              ((screenHeight==834)&&[appDelegate.globalDate isEqualToString:@"men_heads"])){
               ...
               [self.NewImageView setImage:[UIImage imageNamed:@"men-ipad-front.png"]];
               [self.middleImg setImage:[UIImage imageNamed:@"men-ipad-front-tr.png"]];
               [self.previewImageView setImage:[UIImage imageNamed:@"men-ipad-front-tr.png"]];
               
           }
           if ((screenHeight==812)&&[appDelegate.globalDate isEqualToString:@"men_heads"])
           {
               
               [self.NewImageView setImage:[UIImage imageNamed:@"men-front-11.png"]];
               [self.middleImg setImage:[UIImage imageNamed:@"men-front-11-tr.png"]];
               [self.previewImageView setImage:[UIImage imageNamed:@"men-front-11-tr.png"]];
           }
...
- (IBAction)reset:(id)sender {
    ...
    actionSheet4 = [[UIActionSheet alloc] initWithTitle:@"" delegate:self cancelButtonTitle:@"Cancel" destructiveButtonTitle:@"Clear Page" otherButtonTitles:nil, nil];
    actionSheet4.delegate = self;
    
    [actionSheet4 showFromBarButtonItem:sender animated:YES];
...
- (void)saveImage{
    ...
    filenamethumb4= self.labelDrawController.text;
    ...
    NSString *thumbpath = [thumbdocumentsDirectory stringByAppendingPathComponent:filenamethumb4];
    ...
    filenamebig4 = self.stringForLabel;
    filenamebig4 = [filenamebig4 mutableCopy];
    [filenamebig4 appendString: @"big4"];
    filenamebig4 = [filenamebig4 mutableCopy];
    [filenamebig4 appendString: @".png"];
    
    NSLog(@"Результат збереження великоиі картинки: %@.",filenamebig4);
    
    NSArray *paths = NSSearchPathForDirectoriesInDomains(NSDocumentDirectory,                                                NSUserDomainMask, YES);
    NSString *documentsDirectory = [paths objectAtIndex:0];
    NSString* path = [documentsDirectory stringByAppendingPathComponent:filenamebig4];
...
-(void)delegateImagesToEntryView
{
    ...
    [self.frontheadcontrollerdelegate passItemBackFromFront:self didFinishWithItem1:self.imagethumb1
...
-(void)loadMainImage
{
    ...
    [filenamethumb appendString: prefix];
    filenamethumb = [filenamethumb mutableCopy];
    [filenamethumb appendString: @"big4"];
    filenamethumb = [filenamethumb mutableCopy];
    [filenamethumb appendString: @".png"];
...
-(void)setButtonVisible
{
    ...
    [self.popoverBtn3 setEnabled:NO];
...
-(IBAction)buttonTouched:(id)sender
{
        ...
        
    {
        ...
        [self.popoverBtn3 setEnabled:YES];
