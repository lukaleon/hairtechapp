...
- (void)animateTransition:(id<UIViewControllerContextTransitioning>)transitionContext {
    ...
    [UIView animateWithDuration:[self transitionDuration:transitionContext] delay:0 usingSpringWithDamping:300 initialSpringVelocity:5 options:UIViewAnimationOptionTransitionNone animations:^{
