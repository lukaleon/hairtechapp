...
@protocol FrontHeadViewControllerDelegate<NSObject>
...
@interface FrontHeadViewController : UIViewController < WEPopoverControllerDelegate, UIPopoverControllerDelegate, ColorViewControllerDelegate>{
...
int dashLineCount;
    ...
    NSMutableString *filenamebig4;
    UIImage *tempthumbimage;
    WEPopoverController *popoverController4;
...
@property (weak, nonatomic) id<FrontHeadViewControllerDelegate>frontheadcontrollerdelegate;
...
@property (strong, nonatomic) NSString *stringFromVC;
