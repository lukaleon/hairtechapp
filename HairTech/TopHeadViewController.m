...
@implementation TopHeadViewController
...
{
    if(actionSheet3.visible)
        [actionSheet3 dismissWithClickedButtonIndex:-1 animated:YES];
    [self closeAndSave];
...
-(void)setupButtons
{
   ...
   self.btn.layer.cornerRadius = 25.0;
    ...
    self.btn.layer.shadowOffset = CGSizeMake(4.0f, 6.0f);
    self.btn.layer.cornerRadius = 25.0;
...
- (void)viewDidLoad
{
    ...
    if (((screenHeight==736)&&[appDelegate.globalDate isEqualToString:@"new_version"])||((screenHeight==568)&&[appDelegate.globalDate isEqualToString:@"new_version"])||((screenHeight==667)&&[appDelegate.globalDate isEqualToString:@"new_version"]))
    {
        ...
        [self.NewImageView setImage:[UIImage imageNamed:@"top_7p_tr.png"]];
        [self.middleImg setImage:[UIImage imageNamed:@"top_7p_tr.png"]];
        [self.previewImageView setImage:[UIImage imageNamed:@"top_7p_tr.png"]];
    }
    ...
    if (((screenHeight==1024)&&[appDelegate.globalDate isEqualToString:@"new_version"])||
        ...
        [self.NewImageView setImage:[UIImage imageNamed:@"ipad_top.png"]];
        [self.middleImg setImage:[UIImage imageNamed:@"ipad_top_tr.png"]];
        [self.previewImageView setImage:[UIImage imageNamed:@"ipad_top_tr.png"]];
        
    }
    if ((screenHeight==812)&&[appDelegate.globalDate isEqualToString:@"new_version"])
    {
        
        [self.NewImageView setImage:[UIImage imageNamed:@"x_top_tr.png"]];
        [self.middleImg setImage:[UIImage imageNamed:@"x_top_tr.png"]];
        [self.previewImageView setImage:[UIImage imageNamed:@"x_top_tr.png"]];
    }
    ...
    [self.NewImageView setImage:[UIImage imageNamed:@"men-iphone7-top.png"]];
            [self.middleImg setImage:[UIImage imageNamed:@"men-iphone7-top-tr.png"]];
            [self.previewImageView setImage:[UIImage imageNamed:@"men-iphone7-top-tr.png"]];
        }
        ...
        if (((screenHeight==1024)&&[appDelegate.globalDate isEqualToString:@"men_heads"])||
           ...
           ((screenHeight==834)&&[appDelegate.globalDate isEqualToString:@"men_heads"])){
            ...
            [self.NewImageView setImage:[UIImage imageNamed:@"men-ipad-top.png"]];
            [self.middleImg setImage:[UIImage imageNamed:@"men-ipad-top-tr.png"]];
            [self.previewImageView setImage:[UIImage imageNamed:@"men-ipad-top-tr.png"]];
            
        }
        if ((screenHeight==812)&&[appDelegate.globalDate isEqualToString:@"men_heads"])
        {
            
            [self.NewImageView setImage:[UIImage imageNamed:@"men-top-11.png"]];
            [self.middleImg setImage:[UIImage imageNamed:@"men-top-11-tr.png"]];
            [self.previewImageView setImage:[UIImage imageNamed:@"men-top-11-tr.png"]];
        }
...
//[KGStatusBar showWithStatus:@""];
    ...
    if(appDelegate.firstLaunch == YES)
    {
        
        self.blackExtract = [UIColor blackColor];
        self.blueExtract = [UIColor blueColor];
        self.redExtract = [UIColor redColor];
        self.lineExtract = [UIColor purpleColor];
...
- (void)longPressHandlerPen:(UILongPressGestureRecognizer *)gestureRecognizer {
    ...
    if (gestureRecognizer.state==UIGestureRecognizerStateBegan)
    {
        ...
        self.popoverController3 = [[WEPopoverController alloc] initWithContentViewController:contentViewController];
        self.popoverController3.delegate = self;
        [self.popoverController3 presentPopoverFromRect:CGRectMake(penbtn.frame.origin.x,penbtn.frame.origin.y,0,0 ) inView:self.view permittedArrowDirections:UIPopoverArrowDirectionDown animated:YES];
    }
    else if
...
- (void)longPressHandler:(UILongPressGestureRecognizer *)gestureRecognizer {
    ...
    if (gestureRecognizer.state==UIGestureRecognizerStateBegan)
    {
        ...
        [self.popoverController3 presentPopoverFromRect:CGRectMake(blackbtn.frame.origin.x,blackbtn.frame.origin.y,0,0 ) inView:self.view permittedArrowDirections:UIPopoverArrowDirectionDown animated:YES];
    }
    else
    {
...
- (void)longPressHandlerBlue:(UILongPressGestureRecognizer *)gestureRecognizer {
    ...
    if (gestureRecognizer.state==UIGestureRecognizerStateBegan)
    {
        ...
        [self.popoverController3 presentPopoverFromRect:CGRectMake(bluebtn.frame.origin.x,bluebtn.frame.origin.y,0,0 ) inView:self.view permittedArrowDirections:UIPopoverArrowDirectionDown animated:YES];
    }
...
- (void)longPressHandlerRed:(UILongPressGestureRecognizer *)gestureRecognizer {
    ...
    if (gestureRecognizer.state==UIGestureRecognizerStateBegan)
    {
        ...
        [self.popoverController3 presentPopoverFromRect:CGRectMake(redbtn.frame.origin.x,redbtn.frame.origin.y,0,0 ) inView:self.view permittedArrowDirections:UIPopoverArrowDirectionDown animated:YES];
...
- (void)longPressHandlerLine:(UILongPressGestureRecognizer *)gestureRecognizer {
    ...
    if (gestureRecognizer.state==UIGestureRecognizerStateBegan)
    {
        ...
        [self.popoverController3 presentPopoverFromRect:CGRectMake(lineButton.frame.origin.x,lineButton.frame.origin.y,0,0 ) inView:self.view permittedArrowDirections:UIPopoverArrowDirectionDown animated:YES];
    }
...
-(UIColor*)extractRGBforBlack:(UIColor*)tempcolor
{
...
-(void) colorPopoverControllerDidSelectColor:(NSString *)hexColor {
    ...
    if(    blackbtn.selected==YES){
        ...
        if(dashLineCount % 2 == 0){
            ...
            self.drawingView.lineColor = self.blackExtract;
            // [blackbtn setImage: [UIImage imageNamed:@"dash_selected.png"] forState:UIControlStateSelected];
            appDelegate.dashedCurve = YES;
        }
        else{
            self.drawingView.drawTool = ACEDrawingToolTypeCurve;
            self.drawingView.lineColor = self.blackExtract;
            //[blackbtn setImage: [UIImage imageNamed:@"Curve_selected.png"] forState:UIControlStateSelected];
        ...
        [redbtn addGestureRecognizer:longpressredbtn];
        [lineButton addGestureRecognizer:longpresslinebtn];
        //mister = [GzColors colorFromHex:hexColor];
        // mycolor = HexColor(hexColor);
        [self.view setNeedsDisplay];
    ...
    if(bluebtn.selected==YES){
        ...
        //  [self.DrawViewControllerRightDelegate selectedBtn:hexColor];
    ...
    switch(PressedButton.tag)
    {
        ...
        case 1:
           dashLineCount = 0;
            ...
            //self.drawingView.dashlineWidth = 3.0;
        ...
        case 5:
           ...
           /* AppDelegate *appDelegate = (AppDelegate *)[[UIApplication sharedApplication] delegate];
            if(dashLineCount % 2 == 0){
                appDelegate.dashedCurve1 = YES;
                [blackbtn setBackgroundImage: [UIImage imageNamed:@"dash_selected.png"] forState:UIControlStateSelected];
            }
            else{
                [blackbtn setBackgroundImage: [UIImage imageNamed:@"Curve_selected.png"] forState:UIControlStateSelected];
                appDelegate.dashedCurve1 = NO;
            }*/
...
- (IBAction)reset:(id)sender {
    ...
    actionSheet3 = [[UIActionSheet alloc] initWithTitle:@"" delegate:self cancelButtonTitle:@"Cancel" destructiveButtonTitle:@"Clear Page" otherButtonTitles:nil, nil];
    actionSheet3.delegate = self;
    
    [actionSheet3 showFromBarButtonItem:sender animated:YES];
...
- (void)saveImage{
    ...
    NSString *thumbpath = [thumbdocumentsDirectory stringByAppendingPathComponent:filenamethumb3];
    ...
    filenamebig3 = self.stringForLabel;
    filenamebig3 = [filenamebig3 mutableCopy];
    [filenamebig3 appendString: @"big3"];
    filenamebig3 = [filenamebig3 mutableCopy];
    [filenamebig3 appendString: @".png"];
    
    NSLog(@"Результат збереження великоиі картинки: %@.",filenamebig3);
    
    NSArray *paths = NSSearchPathForDirectoriesInDomains(NSDocumentDirectory,                                                NSUserDomainMask, YES);
    NSString *documentsDirectory = [paths objectAtIndex:0];
    NSString* path = [documentsDirectory stringByAppendingPathComponent:filenamebig3];
...
- (void)saveImageRetina{
  ...
  //  UIGraphicsBeginImageContext(self.drawingView.frame.size);
    ...
    filenamethumb3 = [filenamethumb3 mutableCopy];
    [filenamethumb3 appendString: @".png"];
    NSLog(@"Результат thum3: %@.",filenamethumb3);
    ...
    NSLog(@"Результат збереження великоиі картинки big3: %@.",filenamebig3);
...
-(void)delegateImagesToEntryView
{
    ...
    NSLog(@"Результат delegate thumb1: %@.",filenamethumb);
    ...
    NSLog(@"Результат delegate thumb2: %@.",filenamethumb2);
    ...
    filenamethumb3 = [filenamethumb3 mutableCopy];
    [filenamethumb3 appendString: @".png"];
    NSLog(@"Результатdelegate thumb3: %@.",filenamethumb3);
    ...
    NSLog(@"Результат delegate thumb4: %@.",filenamethumb4);
    ...
    NSLog(@"Результат delegate thumb5: %@.",filenamethumb5);
    ...
    [self.topheadcontrollerdelegate passItemBackFromTop:self didFinishWithItem1:self.imagethumb1
...
-(void)loadMainImage
{
    ...
    [filenamethumb appendString: prefix];
    filenamethumb = [filenamethumb mutableCopy];
    [filenamethumb appendString: @"big3"];
    filenamethumb = [filenamethumb mutableCopy];
    [filenamethumb appendString: @".png"];
...
-(void)setButtonVisible
{
    ...
    [self.popoverBtn2 setEnabled:NO];
...
-(IBAction)buttonTouched:(id)sender
{
        ...
        
    {
        ...
        [self.popoverBtn2 setEnabled:YES];
